...
#C file write time: 2019-04-04 13:02:53
codOM.dat
codOM.ctl
...
75 # max yr for sdreport outputs (-1 for endyr; -2 for endyr+Nforecastyrs
...
5 # F_report_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Frates); 4=true F for range of ages; 5=unweighted avg. F for range of ages
4 20 #_min and max age over which average F will be calculated with F_reporting=4 or 5
