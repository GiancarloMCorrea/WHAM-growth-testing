...
my_input = prepare_wham_input(model_name="whamGrowth4",
                              ...
                              growth = list(model = 'vB_classic',
                                            ...
                                            init_vals = c(0.16, 117.9, 3, 0.1, 0.1)), # K, Linf, L1, CV1, CVA
...
# Input_LAA
# input_LAA = SS_report$growthseries[,5:ncol(SS_report$growthseries)]
# input_LAA[nrow(input_LAA) + 1,] = input_LAA[nrow(input_LAA),]
# input_LAA = as.matrix(input_LAA)
# 
